...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      ...
      loadDashboardData();
      fetchInitialAccessEvents(); // Fetch stored events from backend
    }
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white">
        ...
        <nav className="px-4">
          ...
          <div className="group relative">
            <Link href="/settings" className="flex items-center gap-3 px-4 py-3 rounded-lg mb-2 text-slate-300 hover:bg-slate-700 hover:text-white transition-colors">
            ...
            <div className="hidden group-hover:block absolute left-full top-0 ml-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
              <Link href="/settings/attendance" className="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <Icon path="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" className="w-4 h-4 mr-3" />
              ...
              <Link href="/settings/devices" className="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <Icon path="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" className="w-4 h-4 mr-3" />
                Device Settings
              </Link>
              <Link href="/settings/users" className="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <Icon path="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" className="w-4 h-4 mr-3" />
                User Management
              </Link>
              <Link href="/settings/system" className="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <Icon path="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" className="w-4 h-4 mr-3" />
                System Settings
              </Link>
            </div>
          </div>
