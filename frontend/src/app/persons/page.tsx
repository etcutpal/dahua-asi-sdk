...
export default function PersonManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Sidebar */}
      <Sidebar currentPath="/persons" onLogout={() => { logout(); router.push('/login'); }} />
      ...
      <div className="lg:ml-64 p-4 lg:p-8 pt-16 lg:pt-8">
        ...
        <div className="mb-6 lg:mb-8">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-800">Person Management</h1>
              <p className="text-gray-500 mt-1 text-sm lg:text-base">Manage persons and their biometric data</p>
            </div>
